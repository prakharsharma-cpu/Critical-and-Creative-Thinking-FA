🌿 SustainStyle – Empowering Sustainable Consumerism

Eco-App in Action: From Ideation to Interactive Prototype

SustainStyle is an interactive Streamlit-based eco-conscious shopping assistant designed to help users make sustainable purchasing decisions. The app simulates barcode scanning, calculates eco-scores, and rewards users for environmentally responsible choices.

🚀 Live Demo

Streamlit App:
https://critical-and-creative-thinking-fa-zpucze9ml6da69jxy7pbb3.streamlit.app/

Source Code:
https://github.com/prakharsharma-cpu/Critical-and-Creative-Thinking-FA/blob/main/app.py

📌 Project Overview

This project was developed as part of Course 3: Critical and Creative Thinking (FA2) under the Artificial Intelligence (CRS) curriculum. It transforms conceptual ideation from FA1 into a functional UI/UX prototype, focusing on sustainability, usability, and ethical consumer behavior.
